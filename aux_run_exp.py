...
def learn(actor_model,
    ...
    with lock:
        ...
        tmp_aux_loss = learner_outputs['aux_loss']
        learner_outputs = {
            key: tensor[:-1]
            for key, tensor in learner_outputs.items() if key != 'aux_loss'
        }
        learner_outputs['aux_loss'] = tmp_aux_loss
        ...
        aux_loss = learner_outputs['aux_loss']
